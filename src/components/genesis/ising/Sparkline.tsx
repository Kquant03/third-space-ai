...
//  Ising · Sparkline
//  ─────────────────────────────────────────────────────────────────────────
//  A small rolling-window line chart sitting in the observables sidebar.
//  Lantern-skinned — ghost-cyan line on void-soft background, optional
//  critical-value dashed guide (e.g. the Binder cumulant's 0.6107).
//
//  Takes up to 200 samples from the tail of the data array and plots them
//  as a polyline in a tight aspect-controlled SVG.
// ═══════════════════════════════════════════════════════════════════════════
...
export type SparklineProps = {
  ...
  accent?: string; // optional accent override (defaults to ghost)
};
...
export function Sparkline({
  ...
  // Loading-state placeholder when we haven't collected enough samples.
