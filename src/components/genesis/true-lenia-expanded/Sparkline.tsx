...
// ═══════════════════════════════════════════════════════════════════════════
//  Lenia Hyper · Sparkline
//  ─────────────────────────────────────────────────────────────────────────
//  Co-located mirror of the sibling substrates' Sparkline. One per substrate
//  so a layout tweak in one never drags the others. If a further substrate
//  is added, lift the shared piece into /genesis/_shared/.
// ═══════════════════════════════════════════════════════════════════════════
...
export function Sparkline({
  ...
  return (
    <div style={{ marginBottom: 12 }}>
      <SparklineHeader label={label} value={fmtVal} unit={unit} accent={accent} />
      <svg
        width={width}
        height={height}
        style={{
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: 13, color: accent, fontWeight: 500 }}>
        {value}
        {unit && (
          <span style={{ fontSize: 9, color: COLOR.inkFaint, marginLeft: 4 }}>
            {unit}
          </span>
        )}
      </span>
