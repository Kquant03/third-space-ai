...
export interface KoiFrame {
  ...
  /** ageTicks — koi life-age in simulation ticks. Optional on the
   *  wire so older clients without age-aware code don't break. The
   *  diagnostic converts to sim-days via ticksPerSimDay metadata. */
  age?: number;
}
